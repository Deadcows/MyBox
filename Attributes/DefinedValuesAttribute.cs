...
public class DefinedValuesAttributeDrawer : PropertyDrawer
{
	...
	private bool IsString { get { return _variableType == typeof(string); } } 
	private bool IsInt { get { return _variableType == typeof(int); } } 
	private bool IsFloat { get { return _variableType == typeof(float); } } 
}
#endif