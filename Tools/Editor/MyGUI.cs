...
public static class MyGUI
{
	...
	{
		get { return new Color(.8f, .6f, .6f); }
	}

	public static Color Green
	{
		get { return new Color(.6f, .8f, .6f); }
	}

	public static Color Blue
	{
		get { return new Color(.6f, .6f, .8f); }
	}

	public static Color Gray
	{
		get { return new Color(.6f, .6f, .6f); }
	}

	public static Color Yellow
	{
		get { return new Color(.8f, .8f, .2f, .6f); }
	}

	public static Color Brown
	{
		get { return new Color(.7f, .5f, .2f, .6f); }
	}
