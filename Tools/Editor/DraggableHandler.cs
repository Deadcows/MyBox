...
/// <summary>
/// Allows to easilly track state of the draggable handle
/// </summary>
public class DraggableHandler
{
	...
	public static Vector3 DraggableHandle(Vector3 position, float handleSize, Handles.DrawCapFunction capFunc, Color colorSelected, out DragHandleResult result)
	{
